...
Display line numbers on the left side of the window.  See [[http://www.emacswiki.org/emacs/LineNumbers][EmacsWiki LineNumbers]].
...
Since 24.3, a single space in an incremental search matches any number
of spaces.  If I wanted that behavior, I would use a regexp search.
...
Cycle between 1, 0, or original spaces around point where spaces includes newlines and tabs.
...
** Paragraph filling (word wrap)

The variable that starts religious wars.
...
Press "M-Q" to perform the inverse of fill-paragraph ("M-q").  From [[http://pages.sachachua.com/.emacs.d/Sacha.html][Sacha Chua]].
...
[2024-09-15] Not causing Error (frameset): Undefined color: "unspecified-bg"
#+begin_src emacs-lisp
