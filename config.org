...
#+begin_src emacs-lisp
(global-set-key (kbd "C-<f3>") '(lambda () (interactive) (point-to-register 33)))  ;^F3 Save
(global-set-key (kbd "<f3>") '(lambda () (interactive) (jump-to-register 33)))     ; F3 Restore
(global-set-key (kbd "C-<f4>") '(lambda () (interactive) (point-to-register 34)))  ;^F4 Save
(global-set-key (kbd "<f4>") '(lambda () (interactive) (jump-to-register 34)))     ; F4 Restore
#+end_src
